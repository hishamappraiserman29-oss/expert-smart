...
REPORT_TEMPLATES: dict[str, dict] = {
    ...
    "simple_dashboard_draft": {
        ...
        "applicable_asset_types": ["residential", "commercial", "land", "mixed"],
        "applicable_purposes":    ["market_value", "advisory"],
        "supported_methods":      ["sales_comparison", "avm"],
        "required_sections": [
            "ملخص العقار",
            "بيانات التقييم المبدئي",
            "جداول طرق التقييم المبدئية",
            "طريقة AVM",
            "توفيق النتائج المبدئي",
            "نطاق السعر (±10%)",
            "إخلاء المسؤولية",
        ],
        "excel_sheet_sections": [],
        "pdf_sections": [
            "ملخص العقار",
            "بيانات التقييم المبدئي",
            "جداول طرق التقييم المبدئية",
    ...
    "residential_summary_three_methods": {
        ...
        "applicable_asset_types": ["residential", "apartment", "villa", "compound_unit"],
        "applicable_purposes":    ["market_value", "mortgage", "financing", "sale"],
        "supported_methods":      ["sales_comparison", "income_capitalization", "cost_approach", "avm"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "طريقة الدخل",
            "طريقة التكلفة", "AVM", "توفيق النتائج", "الخلاصة والصياغة النهائية",
            "المستندات", "سجل المراجعة",
        ],
        "pdf_sections": [
        ...
        "notes": (
            "تقرير سكني ملخص يشمل الثلاث طرق + AVM بشكل مختصر مع مقارنات وتوفيق. "
    ...
    "full_three_approach_report": {
        ...
        "applicable_asset_types": ["residential", "commercial", "mixed", "land", "villa"],
        "applicable_purposes":    ["market_value", "mortgage", "financing", "sale", "litigation"],
        "supported_methods":      ["sales_comparison", "income_capitalization", "cost_approach", "dcf", "avm"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "طريقة الدخل", "DCF",
            "طريقة التكلفة", "AVM", "توفيق النتائج", "الخلاصة والصياغة النهائية",
            "المستندات", "سجل المراجعة",
        ],
        "pdf_sections": [
        ...
        "notes": (
            "تقرير كامل بالثلاث طرق + AVM مع تحليل تفصيلي وجداول مقارنة وتوفيق معلل. "
            "يصدر بعد مراجعة واعتماد الخبير ويشمل Excel داخلي."
        ),
    },

    "professional_dcf_report": {
        "template_id":          "professional_dcf_report",
        "name_ar":              "تقرير DCF احترافي للتدفقات النقدية المخصومة",
        "audience":             "expert",
        "output_type":          "pdf_and_excel",
        "certification_status": "certified_after_approval",
        "page_scope":           ["professional_valuation"],
        "applicable_asset_types": ["commercial", "industrial", "mixed", "investment", "factory"],
        "applicable_purposes":    ["market_value", "investment", "financing", "ifrs13"],
        "supported_methods":      ["dcf", "income_capitalization", "sales_comparison"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "طريقة الدخل", "DCF",
            "طريقة التكلفة", "توفيق النتائج", "الخلاصة والصياغة النهائية",
            "المستندات", "سجل المراجعة",
        ],
        "pdf_sections": [
            "تقرير تقييم عقاري معتمد",
        ...
        "notes": (
            "تقرير تقييم احترافي يعتمد أساسًا على تحليل التدفقات النقدية المخصومة DCF. "
            "يشمل افتراضات مُفصَّلة ومعدل خصم مُبرَّر وتحليل حساسية. "
            "يصدر بعد مراجعة واعتماد الخبير ويشمل Excel داخلي."
        ),
    },
    ...
    "bank_financing_report": {
        ...
        "certification_status": "certified_after_approval",
        "page_scope":           ["professional_valuation", "simple_valuation"],
        "applicable_asset_types": ["residential", "commercial", "mixed", "land"],
        "applicable_purposes":    ["mortgage", "financing", "ltv_assessment"],
        "supported_methods":      ["sales_comparison", "income_capitalization", "cost_approach", "avm"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "طريقة الدخل",
    ...
    "court_litigation_report": {
        ...
        "certification_status": "certified_after_approval",
        "page_scope":           ["professional_valuation"],
        "applicable_asset_types": ["residential", "commercial", "mixed", "land", "special"],
        "applicable_purposes":    ["litigation", "court", "expert_witness"],
        "supported_methods":      ["sales_comparison", "income_capitalization", "cost_approach"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "طريقة الدخل",
            "طريقة التكلفة", "توفيق النتائج", "الخلاصة والصياغة النهائية",
    ...
    "tax_appeal_report": {
        ...
        "applicable_asset_types": ["residential", "commercial", "land", "mixed"],
        "applicable_purposes":    ["tax_appeal", "tax_assessment"],
        "supported_methods":      ["sales_comparison", "cost_approach"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "طريقة التكلفة",
            "توفيق النتائج", "الخلاصة والصياغة النهائية",
            "المستندات", "سجل المراجعة",
        ],
        "pdf_sections": [
            "تقرير تقييم عقاري معتمد",
    ...
    "special_asset_factory_report": {
        ...
        "certification_status": "certified_after_approval",
        "page_scope":           ["professional_valuation"],
        "applicable_asset_types": ["factory", "industrial", "special", "warehouse"],
        "applicable_purposes":    ["market_value", "financing", "insurance", "liquidation"],
        "supported_methods":      ["cost_approach", "dcf", "sales_comparison"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "طريقة الدخل", "DCF",
            "طريقة التكلفة", "توفيق النتائج", "الخلاصة والصياغة النهائية",
    ...
    "hbu_land_report": {
        ...
        "certification_status": "certified_after_approval",
        "page_scope":           ["professional_valuation"],
        "applicable_asset_types": ["land", "vacant_land", "development_plot"],
        "applicable_purposes":    ["hbu_analysis", "market_value", "development"],
        "supported_methods":      ["sales_comparison", "land_residual"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "توفيق النتائج",
            "الخلاصة والصياغة النهائية", "المستندات", "سجل المراجعة",
        ],
        "pdf_sections": [
            "تقرير تقييم عقاري معتمد",
            "بيانات التكليف ونطاق العمل",
    ...
    "ifrs_fair_value_report": {
        ...
        "certification_status": "certified_after_approval",
        "page_scope":           ["professional_valuation"],
        "applicable_asset_types": ["residential", "commercial", "industrial", "land", "investment"],
        "applicable_purposes":    ["fair_value", "ifrs13", "financial_reporting"],
        "supported_methods":      ["sales_comparison", "income_capitalization", "cost_approach", "dcf"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "طريقة الدخل", "DCF",
            "طريقة التكلفة", "توفيق النتائج", "الخلاصة والصياغة النهائية",
    ...
    "mass_appraisal_portfolio_report": {
        ...
        "applicable_asset_types": ["residential", "commercial", "land", "mixed", "portfolio"],
        "applicable_purposes":    ["mass_appraisal", "portfolio_valuation", "tax_assessment"],
        "supported_methods":      ["statistical_model", "sales_comparison", "cost_approach"],
        "excel_sheet_sections": [
            "Dashboard", "غلاف وملخص", "مقدمة التقرير والافتراضات",
            "بيانات العقار", "مقارنة البيوع", "توفيق النتائج",
            "الخلاصة والصياغة النهائية", "المستندات", "سجل المراجعة",
