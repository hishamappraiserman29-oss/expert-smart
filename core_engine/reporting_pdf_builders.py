...
def _build_simple_valuation_html(payload: dict) -> str:
    ...
    return template.render(
        ...
        # Advanced methodology & compliance keys (Parts B–L)
        hbu_analysis=method_ctx.get("hbu_analysis", {}),
        direct_capitalization_context=method_ctx.get("direct_capitalization_context", {}),
        income_direct_vs_dcf_explanation=method_ctx.get("income_direct_vs_dcf_explanation", ""),
        comparable_adjustment_support=method_ctx.get("comparable_adjustment_support", {}),
        assumptions_registry=method_ctx.get("assumptions_registry", []),
        extraordinary_assumptions=method_ctx.get("extraordinary_assumptions", []),
        hypothetical_conditions=method_ctx.get("hypothetical_conditions", []),
        scope_limitations=method_ctx.get("scope_limitations", []),
        depreciation_breakdown=method_ctx.get("depreciation_breakdown", {}),
        dcf_scenarios=method_ctx.get("dcf_scenarios", {}),
        legal_due_diligence=method_ctx.get("legal_due_diligence", {}),
        esg_enhanced_context=method_ctx.get("esg_enhanced_context", {}),
        esg_score=method_ctx.get("esg_score", ""),
        esg_category=method_ctx.get("esg_category", ""),
        esg_terminal_value_adjustment=method_ctx.get("esg_terminal_value_adjustment", ""),
        esg_value_impact=method_ctx.get("esg_value_impact", ""),
        climate_risk_score=method_ctx.get("climate_risk_score", ""),
        climate_risk_notes=method_ctx.get("climate_risk_notes", ""),
        environmental_impact_assessment=method_ctx.get("environmental_impact_assessment", {}),
        valuation_uncertainty=method_ctx.get("valuation_uncertainty", {}),
        peer_review=method_ctx.get("peer_review", {}),
        # Task 1 new context keys
        source_quality_gate=method_ctx.get("source_quality_gate", {}),
        final_reconciliation=method_ctx.get("final_reconciliation", {}),
        standards_compliance=method_ctx.get("standards_compliance", {}),
        expert_approval=method_ctx.get("expert_approval", {}),
        scope_of_work=method_ctx.get("scope_of_work", {}),
        # Task 2 new context keys
        peer_review_gate=method_ctx.get("peer_review_gate", {}),
        visual_attachments=method_ctx.get("visual_attachments", {}),
        avm_status=method_ctx.get("avm_status", {}),
        rent_consistency_check=method_ctx.get("rent_consistency_check", {}),
        client_recommendation=method_ctx.get("client_recommendation", {}),
        valuation_fee_disclosure=method_ctx.get("valuation_fee_disclosure", {}),
        report_status_visuals=method_ctx.get("report_status_visuals", {}),
        # SWOT Strategic Analysis keys
        swot_analysis=method_ctx.get("swot_analysis", {}),
        swot_hbu_alignment=method_ctx.get("swot_hbu_alignment", {}),
        swot_uncertainty_linkage=method_ctx.get("swot_uncertainty_linkage", {}),
        swot_recommendation_linkage=method_ctx.get("swot_recommendation_linkage", {}),
        # Production Readiness & Governance keys
        valuation_qa_simulation_governance=method_ctx.get("valuation_qa_simulation_governance", {}),
        valuation_comparable_readiness=method_ctx.get("valuation_comparable_readiness", {}),
        valuation_depreciation_age_evidence_gate=method_ctx.get("valuation_depreciation_age_evidence_gate", {}),
        valuation_document_readiness=method_ctx.get("valuation_document_readiness", {}),
        valuation_certification_roadmap=method_ctx.get("valuation_certification_roadmap", {}),
        valuation_geographic_land_price_readiness=method_ctx.get("valuation_geographic_land_price_readiness", {}),
        valuation_source_database_linkage_readiness=method_ctx.get("valuation_source_database_linkage_readiness", {}),
        valuation_parameter_governance=method_ctx.get("valuation_parameter_governance", {}),
        valuation_certification_status=method_ctx.get("valuation_certification_status", {}),
        # Filing/Certification Readiness Gate — canonical alias keys
        valuation_comparison_real_data_readiness=method_ctx.get("valuation_comparison_real_data_readiness", {}),
        valuation_document_certification_risk=method_ctx.get("valuation_document_certification_risk", {}),
        valuation_production_readiness_roadmap=method_ctx.get("valuation_production_readiness_roadmap", {}),
        valuation_final_certification_status=method_ctx.get("valuation_final_certification_status", {}),
        # ── Risk/Decision Pass keys ───────────────────────────────────────────
        valuation_data_fuel_readiness=method_ctx.get("valuation_data_fuel_readiness", {}),
        real_data_entry_readiness=method_ctx.get("real_data_entry_readiness", {}),
        method_consistency_diagnostics=method_ctx.get("method_consistency_diagnostics", {}),
        rent_reconciliation_explanation=method_ctx.get("rent_reconciliation_explanation", {}),
        certification_execution_gate=method_ctx.get("certification_execution_gate", {}),
        dcf_terminal_assumption_support=method_ctx.get("dcf_terminal_assumption_support", {}),
        field_visual_evidence_gate=method_ctx.get("field_visual_evidence_gate", {}),
        avm_completeness_decision=method_ctx.get("avm_completeness_decision", {}),
        valuation_risk_heatmap=method_ctx.get("valuation_risk_heatmap", {}),
        certification_timeline=method_ctx.get("certification_timeline", {}),
        break_even_rent_analysis=method_ctx.get("break_even_rent_analysis", {}),
        valuation_compliance_dashboard=method_ctx.get("valuation_compliance_dashboard", {}),
        mass_appraisal_reference=method_ctx.get("mass_appraisal_reference", {}),
        investment_decision_summary=method_ctx.get("investment_decision_summary", {}),
    )
...
def _build_certified_report_pdf(req: dict) -> Path:
    ...
    html_str = template.render(
        ...
        # Advanced methodology & compliance keys (Parts B–L)
        hbu_analysis=mctx.get("hbu_analysis", {}),
        direct_capitalization_context=mctx.get("direct_capitalization_context", {}),
        income_direct_vs_dcf_explanation=mctx.get("income_direct_vs_dcf_explanation", ""),
        comparable_adjustment_support=mctx.get("comparable_adjustment_support", {}),
        assumptions_registry=mctx.get("assumptions_registry", []),
        extraordinary_assumptions=mctx.get("extraordinary_assumptions", []),
        hypothetical_conditions=mctx.get("hypothetical_conditions", []),
        scope_limitations=mctx.get("scope_limitations", []),
        depreciation_breakdown=mctx.get("depreciation_breakdown", {}),
        dcf_scenarios=mctx.get("dcf_scenarios", {}),
        legal_due_diligence=mctx.get("legal_due_diligence", {}),
        esg_enhanced_context=mctx.get("esg_enhanced_context", {}),
        esg_score=mctx.get("esg_score", ""),
        esg_category=mctx.get("esg_category", ""),
        esg_terminal_value_adjustment=mctx.get("esg_terminal_value_adjustment", ""),
        esg_value_impact=mctx.get("esg_value_impact", ""),
        climate_risk_score=mctx.get("climate_risk_score", ""),
        climate_risk_notes=mctx.get("climate_risk_notes", ""),
        environmental_impact_assessment=mctx.get("environmental_impact_assessment", {}),
        valuation_uncertainty=mctx.get("valuation_uncertainty", {}),
        peer_review=mctx.get("peer_review", {}),
        # Task 1 new context keys
        source_quality_gate=mctx.get("source_quality_gate", {}),
        final_reconciliation=mctx.get("final_reconciliation", {}),
        standards_compliance=mctx.get("standards_compliance", {}),
        expert_approval=mctx.get("expert_approval", {}),
        scope_of_work=mctx.get("scope_of_work", {}),
        # Task 2 new context keys
        peer_review_gate=mctx.get("peer_review_gate", {}),
        visual_attachments=mctx.get("visual_attachments", {}),
        avm_status=mctx.get("avm_status", {}),
        rent_consistency_check=mctx.get("rent_consistency_check", {}),
        client_recommendation=mctx.get("client_recommendation", {}),
        valuation_fee_disclosure=mctx.get("valuation_fee_disclosure", {}),
        report_status_visuals=mctx.get("report_status_visuals", {}),
        # SWOT Strategic Analysis keys
        swot_analysis=mctx.get("swot_analysis", {}),
        swot_hbu_alignment=mctx.get("swot_hbu_alignment", {}),
        swot_uncertainty_linkage=mctx.get("swot_uncertainty_linkage", {}),
        swot_recommendation_linkage=mctx.get("swot_recommendation_linkage", {}),
        # Production Readiness & Governance keys
        valuation_qa_simulation_governance=mctx.get("valuation_qa_simulation_governance", {}),
        valuation_comparable_readiness=mctx.get("valuation_comparable_readiness", {}),
        valuation_depreciation_age_evidence_gate=mctx.get("valuation_depreciation_age_evidence_gate", {}),
        valuation_document_readiness=mctx.get("valuation_document_readiness", {}),
        valuation_certification_roadmap=mctx.get("valuation_certification_roadmap", {}),
        valuation_geographic_land_price_readiness=mctx.get("valuation_geographic_land_price_readiness", {}),
        valuation_source_database_linkage_readiness=mctx.get("valuation_source_database_linkage_readiness", {}),
        valuation_parameter_governance=mctx.get("valuation_parameter_governance", {}),
        valuation_certification_status=mctx.get("valuation_certification_status", {}),
        # Filing/Certification Readiness Gate — canonical alias keys
        valuation_comparison_real_data_readiness=mctx.get("valuation_comparison_real_data_readiness", {}),
        valuation_document_certification_risk=mctx.get("valuation_document_certification_risk", {}),
        valuation_production_readiness_roadmap=mctx.get("valuation_production_readiness_roadmap", {}),
        valuation_final_certification_status=mctx.get("valuation_final_certification_status", {}),
        # ── Risk/Decision Pass keys ───────────────────────────────────────────
        valuation_data_fuel_readiness=mctx.get("valuation_data_fuel_readiness", {}),
        real_data_entry_readiness=mctx.get("real_data_entry_readiness", {}),
        method_consistency_diagnostics=mctx.get("method_consistency_diagnostics", {}),
        rent_reconciliation_explanation=mctx.get("rent_reconciliation_explanation", {}),
        certification_execution_gate=mctx.get("certification_execution_gate", {}),
        dcf_terminal_assumption_support=mctx.get("dcf_terminal_assumption_support", {}),
        field_visual_evidence_gate=mctx.get("field_visual_evidence_gate", {}),
        avm_completeness_decision=mctx.get("avm_completeness_decision", {}),
        valuation_risk_heatmap=mctx.get("valuation_risk_heatmap", {}),
        certification_timeline=mctx.get("certification_timeline", {}),
        break_even_rent_analysis=mctx.get("break_even_rent_analysis", {}),
        valuation_compliance_dashboard=mctx.get("valuation_compliance_dashboard", {}),
        mass_appraisal_reference=mctx.get("mass_appraisal_reference", {}),
        investment_decision_summary=mctx.get("investment_decision_summary", {}),
    )
