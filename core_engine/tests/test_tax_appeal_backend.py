...
def test_TAB74_reference_extraction_summary_json_exists_and_valid():
    ...
    if not p.exists():
        pytest.skip(f"reference_extraction_summary.json absent (generated by deleted temp script): {p}")
...
def test_TAB193_property_specific_qa_outputs_exist():
    ...
    if not out_dir.exists():
        pytest.skip(f"QA output directory absent (generated by deleted temp script): {out_dir}")
...
def test_TAB217_qdrant_internet_ocr_inactive_and_qa_outputs_exist():
    ...
    if not out_dir.exists():
        pytest.skip(f"RI QA output directory absent (generated by deleted temp script): {out_dir}")
    pdfs  = list(out_dir.glob("*.pdf"))
    xlsxs = list(out_dir.glob("*.xlsx"))
...
def test_TAB242_cdm_qa_outputs_exist():
    ...
    if not out_dir.exists():
        pytest.skip(f"CDM QA output directory absent (generated by deleted temp script): {out_dir}")
    pdfs  = list(out_dir.glob("*.pdf"))
    xlsxs = list(out_dir.glob("*.xlsx"))
...
def test_TAB268_mps_qa_outputs_exist():
    ...
    if not out_dir.exists():
        pytest.skip(f"MPS QA output directory absent (generated by deleted temp script): {out_dir}")
    pdfs  = list(out_dir.glob("*.pdf"))
    xlsxs = list(out_dir.glob("*.xlsx"))
...
def test_TAB313_edd_qa_outputs_exist():
    ...
    if not out_dir.exists():
        pytest.skip(f"EDD QA output directory absent (generated by deleted temp script): {out_dir}")
    pdfs  = list(out_dir.glob("*.pdf"))
    xlsxs = list(out_dir.glob("*.xlsx"))
...
def test_TAB314_cav2_qa_outputs_exist():
    ...
    if not out_dir.exists():
        pytest.skip(f"CAV2 QA output directory absent (generated by deleted temp script): {out_dir}")
    pdfs  = list(out_dir.glob("*.pdf"))
    xlsxs = list(out_dir.glob("*.xlsx"))
